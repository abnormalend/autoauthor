...
The laws and measures below are the standard the scored dimensions are
judged against. Read them first, then score the dimensions.
...
The magic system needs HARD RULES with COSTS and LIMITATIONS per
Sanderson's Second Law, and limitations >= powers in narrative prominence.
...
4. **An antagonist** — not a villain. Someone whose interests conflict
   ...
   should be understandable, not evil-for-evil's-sake.
...
Required concept fields (these fantasy-specific fields and phrasings
