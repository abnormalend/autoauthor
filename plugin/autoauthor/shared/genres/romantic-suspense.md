...
- writer_persona — a working suspense-and-romance author who reads for whether each plot holds the other up, whether the black moment and the threat's peak are the same event, and whether the couple's choice is what ends the danger
...
identical, the couple is holding nothing up and the book has a problem
