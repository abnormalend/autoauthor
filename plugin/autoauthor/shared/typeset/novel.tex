...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[LE]{\small\textsc{NOVEL-TITLE-SHORT}}
...
\newcommand{\makenoveltitle}{%
  ...
  {\Huge\textsc{NOVEL-TITLE}}\\[0.4in]

  {\small------\quad$\diamond$\quad------}\\[0.5in]

  {\large\textit{A Novel}}\\[1in]

  {\Large\textsc{NOVEL-AUTHOR}}\\[1.5in]
...
\usepackage{hyperref}
\hypersetup{
  pdftitle={NOVEL-TITLE},
  pdfauthor={NOVEL-AUTHOR},
  pdfsubject={NOVEL-GENRE},
  hidelinks
}
...
{\small created by NOVEL-AUTHOR.}\\[18pt]
