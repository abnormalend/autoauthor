...
when it scaffolds the project. `novel-foundation` fills it after
...
changes — moving one chapter changes both summary lines. `novel-draft`
...
`novel-revise` and `novel-review` re-verify the whole table against the
manuscript.
